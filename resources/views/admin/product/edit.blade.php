                        ...
                        <td class="flex justify-center">
                            <form method="POST" action="{{route('products.update', $product)}}" enctype="multipart/form-data">
                                ...
                                <ol>
                                    ...
                                    <input type="text" id="item_price" name='price' value="{{old('price')??$product->price}}">
                                    <label for="product_image">Image:</label>
                                    <input type="file" id="product_image" name="image" class="form-control"  value="{{old('image')??$product->image}}">

                                    <label for="categoryParent">Parent:</label>
                                    <select name="category_id" id="categoryParent">

    ...
    <div class="grid-container">
        <div class="grid-x">
            <div class="cell small-12">
                ...
                <h1 class="text-center">{{$category->name}} Details</h1>
                ...
                <table class="items-table">
                    ...
                    <tr class="table-expand-row" data-open-details>
                        ...
                        <td class="flex justify-center">
                            <a href="{{route('categories.show',$category)}}" class="button button-primary"
                               type="submit">view</a>
                            <a href="{{route('categories.edit',$category)}}" class="button button-primary"
                               type="submit">edit</a>
